...
import ModalAnimal from "@/src/components/modalAnimal/modalAnimal";
  ...
  return (
    <View>
      <View className="bg-white rounded-t-lg h-full">
        ...
        <ScrollView horizontal={true} className="mt-14 px-4 flex w-full h-[230px]">
          ...
          <View className="flex mr-4 ">
            ...
            >
              <Text
                className=" text-white text-lg mt-[160px] p-2"
              >
                Teste
              </Text>
            </ImageBackground>
